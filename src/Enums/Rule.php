...
use AdityaZanjad\Validator\Rules\Alpha;
...
use AdityaZanjad\Validator\Rules\AlphaNum;
use AdityaZanjad\Validator\Rules\TypeFile;
use AdityaZanjad\Validator\Rules\TypeJson;
use AdityaZanjad\Validator\Rules\AlphaDash;
use AdityaZanjad\Validator\Rules\DateAfter;
...
use AdityaZanjad\Validator\Rules\DateBefore;
...
use AdityaZanjad\Validator\Rules\AlphaNumSpecial;
use AdityaZanjad\Validator\Rules\RequiredWithAll;
use AdityaZanjad\Validator\Rules\RequiredWithout;
use AdityaZanjad\Validator\Rules\DateAfterOrEqual;
use AdityaZanjad\Validator\Rules\DateBeforeOrEqual;
...
class Rule extends Enum
{
    ...
    public const ALPHA                  =   Alpha::class;
    ...
    public const DATE_GT                =   DateAfter::class;
    public const DATE_LT                =   DateBefore::class;
    public const INTEGER                =   TypeInteger::class;
    public const NUMERIC                =   Numeric::class;
    public const DATE_GTE               =   DateAfterOrEqual::class;
    public const DATE_LTE               =   DateBeforeOrEqual::class;
    public const REQUIRED               =   Required::class;
    public const ALPHA_NUM              =   AlphaNum::class;
    ...
    public const ALPHA_DASH             =   AlphaDash::class;
    ...
    public const ALPHA_NUM_SPECIAL      =   AlphaNumSpecial::class;
