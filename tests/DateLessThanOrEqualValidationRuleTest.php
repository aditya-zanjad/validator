...
final class DateLessThanOrEqualValidationRuleTest extends TestCase
{
    ...
    public function testAssertionsPass(): void
    {
        $validator = validate([
            ...
            'abc'   =>  'date|date_lte:1994-05-11',
            'def'   =>  'date:d-m-Y|date_lte:11-05-2025',
            'ghi'   =>  'date:m-d-Y|date_lte:05-11-1994',
            'jkl'   =>  'date: d M, Y|date_lte:12 September\, 1995',
            'mno'   =>  'date: d/m/Y|date_lte: 11/05/1994    ',
            'pqr'   =>  'date:m/d/Y|date_lte:10/11/1994',
            'uvw'   =>  'date: F d, Y|date_lte:June 01\, 2000',
            'xyz'   =>  'date:Y/m/d|date_lte:768700800',
            'zyx'   =>  'date|date_lte:2025-05-11',
            'wvu'   =>  'date|date_lte:768614400'
        ]);
    ...
    public function testAssertionsFail(): void
    {
       $validator = validate([
            ...
            'abc'   =>  'date|date_lte:1994-05-03',
            'def'   =>  'date:d-m-Y|date_lte:10-05-1994',
            'ghi'   =>  'date:m-d-Y|date_lte:05-10-1994',
            'jkl'   =>  'date: d M, Y|date_lte:11 Jan\, 1994',
            'mno'   =>  'date: d/m/Y|date_lte: 01/02/1994    ',
            'pqr'   =>  'date:m/d/Y|date_lte:05/11/1993',
            'uvw'   =>  'date: F d, Y|date_lte:March 11\, 1994',
            'xyz'   =>  'date:Y/m/d|date_lte:1993-12-11',
            'zyx'   =>  'date|date_lte:768614400'
        ]);
