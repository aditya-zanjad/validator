...
class NumericValidationRuleTest extends TestCase
{
     ...
     * @return void
     */
    public function testNumericValidationRulePasses(): void
    {
        $validator = validate([
            'abc' => 123,
            'def' => 0.12311551,
            ...
            'abc'                   =>  'required|numeric|integer',
            'def'                   =>  'numeric',
            'pqr.123.456.789.123'   =>  'numeric',
            'xyz'                   =>  'numeric',
            'ghi'                   =>  'numeric',
            'axz'                   =>  'numeric',
            'mno'                   =>  'numeric'
     ...
     * @return void
     */
    public function testNumericValidationRuleFails(): void
    {
        $validator = validate([
            'abc' => 'abcdefghi',
            'def' => '-1abc',
