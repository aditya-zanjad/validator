...
final class DateGreaterThanValidationRuleTest extends TestCase
{
     ...
     * @return void
     */
    public function testDateGreaterThanValidationRulePasses(): void
    {
        $validator = validate([
            'abc'   =>  '1994-05-11',
            'def'   =>  '11-05-1994',
            ...
            'abc'   =>  'date|date_gt:1994-05-10',
            'def'   =>  'date:d-m-Y|date_gt:09-05-1994',
            'ghi'   =>  'date:m-d-Y|date_gt:05-05-1994',
            'jkl'   =>  'date: d M, Y|date_gt:11 May\, 1993',
            'mno'   =>  'date: d/m/Y|date_gt: 15/04/1994    ',
            'pqr'   =>  'date:m/d/Y|date_gt:01/11/1994',
            'uvw'   =>  'date: F d, Y|date_gt:Apr 01\, 1780',
            'xyz'   =>  'date:Y/m/d|date_gt:768613300',
            'zyx'   =>  'date|date_gt:1800-05-11',
            'wvu'   =>  'date|date_gt:768614300'
        ]);
     ...
     * @return void
     */
    public function testDateGreaterThanValidationRuleFails(): void
    {
       $validator = validate([
            'abc'   =>  '1994-05-11',
            'def'   =>  '11-05-1994',
            ...
            'abc'   =>  'date|date_gt:1994-05-13',
            'def'   =>  'date:d-m-Y|date_gt:10-05-1995',
            'ghi'   =>  'date:m-d-Y|date_gt:09-11-1994',
            'jkl'   =>  'date: d M, Y|date_gt:11 Aug\, 1994',
            'mno'   =>  'date: d/m/Y|date_gt: 11/12/1994    ',
            'pqr'   =>  'date:m/d/Y|date_gt:05/11/1995',
            'uvw'   =>  'date: F d, Y|date_gt:Sep 12\, 2015',
            'xyz'   =>  'date:Y/m/d|date_gt:1994-06-12',
            'zyx'   =>  'date|date_gt:1752664339'
        ]);
