...
#[CoversClass(DateGte::class)]
#[CoversFunction('\AdityaZanjad\Validator\validate')]
final class DateGreaterThanOrEqualValidationRuleTest extends TestCase
{
    /**
    ...
    public function testRulePasses(): void
    {
        $validator = validate([
            ...
            'abc'   =>  'date|date_gte:1994-05-10',
            'def'   =>  'date:d-m-Y|date_gte:09-05-1994',
            'ghi'   =>  'date:m-d-Y|date_gte:05-05-1994',
            'jkl'   =>  'date: d M, Y|date_gte:11 May\, 1993',
            'mno'   =>  'date: d/m/Y|date_gte: 11/05/1994    ',
            'pqr'   =>  'date:m/d/Y|date_gte:01/11/1994',
            'uvw'   =>  'date: F d, Y|date_gte:May 11\, 1994',
            'xyz'   =>  'date:Y/m/d|date_gte:768613300',
            'zyx'   =>  'date|date_gte:1800-05-11',
            'wvu'   =>  'date|date_gte:768614400'
        ]);
    ...
    public function testRuleFails(): void
    {
       $validator = validate([
            ...
            'abc'   =>  'date|date_gte:1994-05-13',
            'def'   =>  'date:d-m-Y|date_gte:10-05-1995',
            'ghi'   =>  'date:m-d-Y|date_gte:09-11-1994',
            'jkl'   =>  'date: d M, Y|date_gte:11 Aug\, 1994',
            'mno'   =>  'date: d/m/Y|date_gte: 11/12/1994    ',
            'pqr'   =>  'date:m/d/Y|date_gte:05/11/1995',
            'uvw'   =>  'date: F d, Y|date_gte:Sep 12\, 2015',
            'xyz'   =>  'date:Y/m/d|date_gte:1994-06-12',
            'zyx'   =>  'date|date_gte:1752664339'
        ]);
